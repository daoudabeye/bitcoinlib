...
class IkawariClient(BaseClient):
    """
    Class to interact with ikawari, the Bitcoin deamon
    """

    @staticmethod
    def from_config(configfile=None, network='ikawari'):
        """
        Read settings from ikawari config file
        ...
        :return IkawariClient:
        """
        try:
            config = configparser.ConfigParser(strict=False)
        except TypeError:
            config = configparser.ConfigParser()
        config_fn = 'ikawari.conf'
        ...
        return IkawariClient(network, url)
...
if __name__ == '__main__':
    ...
    bdc = IkawariClient()
    # dc = IkawariClient('http://localhost:15002')
    ...
    t = bdc.getrawtransaction('00027e95e43b355e0531c866d9bcd472bb0c219f91cb472bd5b35ad3a1f2345b')
    pprint(t)
